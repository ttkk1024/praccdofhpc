...
- [7.1 序列比对并行化](#7.1 序列比对并行化)
  - [7.1.1 BLAST并行化](#7.1.1 BLAST并行化)
  - [7.1.2 Smith-Waterman算法并行化](#7.1.2 Smith-Waterman算法并行化)
  - [7.1.3 序列数据库索引](#7.1.3 序列数据库索引)
- [7.2 基因组装优化](#7.2 基因组装优化)
  - [7.2.1 De Bruijn图并行构建](#7.2.1 De Bruijn图并行构建)
  - [7.2.2 OLC算法并行实现](#7.2.2 OLC算法并行实现)
  - [7.2.3 基因组拼接优化策略](#7.2.3 基因组拼接优化策略)
- [7.3 变异检测加速](#7.3 变异检测加速)
  - [7.3.1 并行SNP检测](#7.3.1 并行SNP检测)
  - [7.3.2 Indel检测算法优化](#7.3.2 Indel检测算法优化)
  - [7.3.3 结构变异分析并行化](#7.3.3 结构变异分析并行化)
- [7.4 本章小结](#7.4 本章小结)
- [练习题](#练习题)
